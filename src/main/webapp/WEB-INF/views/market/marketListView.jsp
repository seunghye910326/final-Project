...
<style>
    ...
    #market_wrap .textSection img{
       margin-left: 15%;
       margin-bottom: 5%;
    }

    #market_wrap .textSection p{
        margin-top: 80px;
    }
...
<div id="market_wrap">
        ...
        <div id="innerSection">
            ...
            <div class="textSection" style="height: 250px;">
                <img src="https://cdn-icons-png.flaticon.com/512/7551/7551300.png" style="width: 200px; height: 200px; display: inline-block;">
            </div>
        </div>
            ...
            <div class="row">
                ...
                <script>
                    ...
                    $(function(){
                            ...
                            if('${list[0].marketCategory}' == 'all'){
                                
                                $('select[name="marketCategory"]')
                                .find('option[value="모두"]')
                                .attr("selected",true);         
        
                            }else{
                                
                                $('select[name="marketCategory"]')
                                .find('option[value="${list[0].marketCategory}"]')
                                .attr("selected",true);
                    ...
                    function changeMarketCategory(){
                        ...
                        if($('#marketCategory').val() != null){
                            ...
                            if(changeCategory != '모두'){
                                ...
                                location.href="listCatogory.mk?marketCategory=" 
                                + changeCategory;

                            }else{

                                location.href="list.mk?marketCategory=all";
